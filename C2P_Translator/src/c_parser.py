...
def p_var_declaration(p):
    '''var_declaration : var_direct_declaration
                          | var_pointer_declaration
                          | var_declaration_init'''
    p[0]=('var_declaration',p[1])

def p_var_direct_declaration(p):
    'var_direct_declaration : type_specifier IDENTIFIER SEMICOLON'
    p[0] = ('var_direct_declaration', p[1], p[2])

def p_var_pointer_declaration(p):
    'var_pointer_declaration : type_specifier TIMES IDENTIFIER SEMICOLON'
    p[0] = ('var_pointer_declaration', p[1], p[2], p[3])

def p_var_declaration_init(p):
    'var_declaration_init : type_specifier IDENTIFIER ASSIGN expression SEMICOLON'
...
def p_array_declaration_2(p):
    ...
    p[0] = ('array_declaration_init', "1",p[1], p[2], p[4], p[8])
...
def p_array_declaration_3(p):
    ...
    p[0] = ('array_declaration_init', '2',p[1], p[2], p[7])
...
def p_assignment_expression_1(p):
    ...
    p[0] = ('assignment_expression_identifier', p[1], p[3])

def p_assignment_expression_2(p):
    'assignment_expression : array_access ASSIGN expression'
    p[0] = ('assignment_expression_array_access', p[1], p[3])
...
def p_for_expression_statement(p):
    'for_expression_statement : FOR LPAREN expression_statement expression_statement expression RPAREN statement'
    p[0]=('for_expression_statement',p[3],p[4],p[5],p[7])

def p_for_var_declaration(p):
    'for_var_declaration : FOR LPAREN var_declaration expression_statement expression RPAREN statement'
    p[0]=('for_var_declaration',p[3],p[4],p[5],p[7])
